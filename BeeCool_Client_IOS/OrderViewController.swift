...
//        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "NVG1"), forBarMetrics: UIBarMetrics.Default)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCellWithIdentifier("orderCell") as OrderTableViewCell
        var namelabel = cell.contentView.viewWithTag(101) as UILabel
        var resultlabel = cell.contentView.viewWithTag(102) as UILabel
        var timelabel = cell.contentView.viewWithTag(103) as UILabel
